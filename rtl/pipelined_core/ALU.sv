...
module ALU (
    ...
    always_comb begin
        ...
        case (ALU_Op)
			...
			ALU_SLT   :  alu_result   = $signed(op1) < $signed(op2) ? DATA_WIDTH'(1) : DATA_WIDTH'(0);
			ALU_SLTU  :  alu_result   = op1 < op2 ? DATA_WIDTH'(1) : DATA_WIDTH'(0);
			...
			ALU_SLTI  :  alu_result   = $signed(op1) < $signed(immediate) ? DATA_WIDTH'(1) : DATA_WIDTH'(0);
			ALU_SLTIU :  alu_result   = op1 < immediate ? DATA_WIDTH'(1) : DATA_WIDTH'(0);
